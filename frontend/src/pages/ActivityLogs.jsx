...
const ActivityLogs = () => {
    ...
    return (
        <div className="flex h-screen bg-teeny-greeny font-sans text-text-dark">
            ...
            {/* SIDEBAR */}
            <aside className="w-72 bg-white border-r border-blue-greeny/5 flex flex-col p-8 overflow-y-auto shrink-0">
            ...
            <main className="flex-1 overflow-y-auto p-10">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                    <div>
                        {/* ✅ REMOVED 'italic' - FONT IS NOW STRAIGHT */}
                        <h2 className="text-3xl font-heading font-black text-text-dark uppercase">
                            System Logs
                        </h2>
